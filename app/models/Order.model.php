...
class Order extends Model
{
    ...
    {
        return $this->query("SELECT o.*, u.first_name, u.last_name, u.phone, u.address_line1, u.address_line2, u.address_city, u.address_district FROM `order` o LEFT JOIN user u ON o.user = u.user_id WHERE o.courier=:courier AND o.status = 'completed';", ["courier" => $id]);
    }
