...
<memberProfile>
    ...
    <?php endif; ?>
    <h1 class="title edit-subscription">
    ...
    <form class="frm-edit-subscription" action="<?= ROOT ?>/librarian/editSubscription/<?= $subscription->subscription_id ?>/edit" method="POST">
        ...
        <div class="form-field">
            ...
            <input type="number" min="0" step="0.01" name="price" value="<?= htmlspecialchars($subscription->price) ?>" required>
        ...
        <div class="form-field">
            ...
            <input type="number" name="max_books" value="<?= htmlspecialchars($subscription->max_books) ?>" required>
        ...
        <div class="form-field">
            ...
            <input type="number" name="borrowing_period" value="<?= htmlspecialchars($subscription->borrowing_period) ?>" required>
        ...
        <p>
            <button type="submit" class="add-btn">
                ...
                <span class="edit-subscription">Save Changes</span>
            </button>
        </p>
    </form>
</memberProfile>
