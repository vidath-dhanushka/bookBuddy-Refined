    ...
    <form id="uploadForm" class="frm-add-book" method="post" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            <div class="form-column">
                ...
                <div class="form-field">
                    ...
                    <div class="image-uploader">
                        ...
                        <img id="preview" src="<?= isset($_SESSION['temp_cover_path']) ? ROOT . '/' . $_SESSION['temp_cover_path'] : ROOT . '/assets/images/books/book_image.jpg';  ?>" style="display: block;">
            ...
            <div class="form-column">
                ...
                <div class="form-field">
                    <label>Pages</label>
                    <input type="number" name="pages" value="<?= set_value('pages') ?>">
                ...
                <!-- E-Book File Upload (full-width row) -->
                <!-- E-Book File Upload -->
                <div class="form-field">
