    ...
    <main id="contentToCapture">
        ...
        <div class="insights">
            <div class="sales box-1">
                ...
                <span style="display: flex; justify-content: center; align-items: center; height: 25px; width: 25px;"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
...
<script>
    const profitabilityData = <?php echo json_encode($data['profit_chart']); ?>;
</script>
